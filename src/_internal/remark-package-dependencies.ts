 ...
 * Workspace dependency lookup helpers for Remark config validation rules.
 */
 ...
 *
 * @param specifier - Package specifier from Remark extends/plugins entry.
 *
 * @returns Package name root (for example `Remark-order`) when parsable.
 */
